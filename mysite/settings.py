...
SECRET_KEY = 'django-insecure-qn&glc6rbtb4=rkci^iz3m^hs)a(kba!*e!-%9ct00q%71ziti'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'weaponry/media')
MEDIA_URL = '/media/'

LOGIN_REDIRECT_URL = '/'

TINYMCE_DEFAULT_CONFIG = {'height': 360, 'width': 1120, 'cleanup_on_startup': True, 'custom_undo_redo_levels': 20,
                          'selector': 'textarea',
